        ...
        <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white shadow-sm">
            <div className="relative h-[550px] overflow-hidden bg-slate-100">
              ...
              <div className="absolute bottom-[20%] right-[15%] h-48 w-48 rounded-full border-4 border-green-200" />
              ...
              <div className="absolute bottom-[27%] right-[18%] flex items-center gap-3 rounded-xl bg-white px-4 py-3 shadow-lg">
